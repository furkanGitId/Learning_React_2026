...
- **Reusable pieces:** Build once, use anywhere.
...
- **What React does:** Handles the user interface (what you see in the browser).
- **What React doesn't do:** Database operations, server logic, authentication.
